...
Bei Wright gibt es drei verschiedene Klassifizierungen: simple, decision-making und power-class. Simple ist die einfachste Klassifizierung, die nur die Position im Betrieb berücksichtigt. Decision-making berücksichtigt zusätzlich die Anzahl der Angestellten und die Kontrolle über die Arbeit. Power-class berücksichtigt zusätzlich die tägliche Kontrolle über die Arbeit. 

Bei Goldthorpe gibt es nur eine Klassifizierung, die auf der ISCO08 basiert. Die Klassifizierung berücksichtigt die Position im Betrieb, die Anzahl der Angestellten und die Kontrolle über die Arbeit. Dabei wird die ISCO08 in eine ESEC-Klassifizierung umgewandelt. Dann wird die ESEC-Klassifizierung in 9 Klassen unterteilt und die Personen werden entsprechend eingeteilt.
